...
return (function () {
        ...
        function shouldInclude(elt) {
            ...
            // include button values if present
        ...
        function processInputValue(processed, values, elt) {
            ...
            if (shouldInclude(elt)) {
                ...
                if (getRawAttribute(elt, "multiple") !== null) {
                  value = Array.from(elt.children).filter(function(el) { return el.selected }).map(function(el) { return el.value })
                } else {
                  value = elt.value;
                }
